     ...
     <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center py-32">
       ...
       >
         ...
         <div className="mt-16 overflow-hidden">
           <p className="text-gray-400 text-sm uppercase tracking-[5px] mb-6">
             Trusted Partners
           </p>
           ...
           <div className="relative overflow-hidden">
             <div className="flex items-center gap-16 whitespace-nowrap animate-marquee">
               ...
               <img
                 ...
                 alt=""
                 className="h-10 opacity-70 invert hover:opacity-100 transition"
               />
       ...
       >
         ...
         <div className="relative">
           ...
           <motion.div
             ...
             className="z-99 absolute -bottom-10 -left-10 bg-white/10 backdrop-blur-2xl border border-white/10 p-6 rounded-3xl shadow-2xl w-72"
           >
